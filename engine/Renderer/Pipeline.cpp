...
Pipeline::Pipeline(VulkanContext& context, VkRenderPass renderPass, VkExtent2D extent)
    : m_context(context)
{
...
void Pipeline::createPipeline(VkRenderPass renderPass, VkExtent2D extent) {
    auto vertShaderCode = m_context.readFile("shaders/default.vert.spv");
    auto fragShaderCode = m_context.readFile("shaders/default.frag.spv");
